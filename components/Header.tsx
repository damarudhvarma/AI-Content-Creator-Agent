...
const Header = () => {
    ...
    return (
        <header className='sticky flex top-0  left-0 right-0 px-4 md:px-0 bg-white/80 backdrop-blur-sm border-b border-gray-200 z-50' >
            <div className='container mx-auto'>
                ...
                <div className='flex items-center gap-4'>
                    <SignedIn>
                        ...
                        <div className='p-2 w-10 h-10 flex items-center justify-center rounded-full bg-blue-100 border-blue-200'>
                            <UserButton />
                        </div>
                    </SignedIn>
