...
<div className='@container bg-white rounded-xl'>
    ...
    <div className='flex-shrink-0'>
        ...
        width={500}
        height={500}
        className='w-full rounded-xl shadow-md hover:shadow-xl
        transition-shadow duration-300'
        />

    
     </div> 
    <div className='flex-gorw space-y-4'>
        ...
        <div className='grid grid-cols-2 @lg:grid-cols-4 gap-4 pt-4'>
                <div className='bg-gray-50 rounded-lg p-3 transition-all duaration-300 hover:bg-gray-100'>
                ...
                <div className='bg-gray-50 rounded-lg p-3 transition-all duration-300 hover:bg-gray-100'>
                    ...
                    <p className='font-medium txt'>{video.views}</p>
                </div>
